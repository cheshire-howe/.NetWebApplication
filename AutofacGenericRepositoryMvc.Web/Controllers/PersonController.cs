...
namespace AutofacGenericRepositoryMvc.Web.Controllers
{
    public class PersonController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Phone,Address,State,CountryId,Languages,CreatedDate,CreatedBy,UpdatedDate,UpdatedBy")] PersonDto personDto)
        {
